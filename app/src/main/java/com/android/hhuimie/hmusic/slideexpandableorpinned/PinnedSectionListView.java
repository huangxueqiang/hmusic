...
import com.android.hhuimie.hmusic.BuildConfig;

public class PinnedSectionListView extends ActionSlideExpandableListView {
	...
	public void setAdapter(ListAdapter adapter) {
		...
		if (BuildConfig.DEBUG && adapter != null) {
			if (!(adapter instanceof PinnedSectionListAdapter))
				throw new IllegalArgumentException("adapter异常");
			if (adapter.getViewTypeCount() < 2)
				throw new IllegalArgumentException("viewtype异常");
